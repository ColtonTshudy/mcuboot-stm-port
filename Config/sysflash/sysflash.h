// TODO implement the .c for stm32
...
#define FLASH_AREA_IMAGE_PRIMARY(x) (((x) == 0) ? FLASH_AREA_IMAGE_0_PRIMARY : ((x) == 1) ? FLASH_AREA_IMAGE_1_PRIMARY \
                                                                                          : FLASH_SLOT_DOES_NOT_EXIST)
#define FLASH_AREA_IMAGE_SECONDARY(x) (((x) == 0) ? FLASH_AREA_IMAGE_0_SECONDARY : ((x) == 1) ? FLASH_AREA_IMAGE_1_SECONDARY \
                                                                                              : FLASH_SLOT_DOES_NOT_EXIST)
